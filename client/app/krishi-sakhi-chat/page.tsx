...
import { Mic, Send, X, Play, User, Bot, Sparkles, ThumbsUp, ThumbsDown, MessageSquare, Zap } from "lucide-react"
                    ...
                    <div className="flex flex-col items-center">
                      {isListening ? (
                        ...
                        <>
                          ...
                          <span className="text-lg font-bold">Voice Assistant</span>
                        </>
                      )}
                    </div>
                  </Button>
                  ...
                  <div className="mt-4 text-center p-4 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl shadow-sm">
                    <div className="flex items-center justify-center gap-3">
                      <div className="flex gap-1">
                        ...
                        <div className="w-2 h-4 bg-green-500 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                              ...
                              <div className={`relative rounded-2xl p-4 shadow-sm ${
                                ...
                                <div className={`flex items-center justify-between mt-3 text-xs ${
                                  ...
                                  {message.sender === "bot" && (
                                    <div className="flex gap-1">
                                      <button
                                        className={`h-6 w-6 flex items-center justify-center rounded-full ${message.isLiked === true ? 'text-green-600 bg-green-100' : 'hover:text-green-600 text-gray-500'}`}
                                        onClick={() => handleFeedback(message.id, true)}
                                      >
                                        <ThumbsUp className="h-3 w-3" />
                                      </button>
                                      <button
                                        className={`h-6 w-6 flex items-center justify-center rounded-full ${message.isLiked === false ? 'text-red-600 bg-red-100' : 'hover:text-red-600 text-gray-500'}`}
                                        onClick={() => handleFeedback(message.id, false)}
                                      >
                                        <ThumbsDown className="h-3 w-3" />
                                      </button>
                                      <button
                                        className="h-6 w-6 flex items-center justify-center rounded-full hover:text-blue-600 text-gray-500"
                    ...
                    <div className="border-t border-green-200 p-4 bg-gradient-to-r from-green-50 to-white">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          placeholder="Type your agriculture question here... या माइक पर क्लिक करें..."
